...
_NAMEDTENSOR = _descriptor.Descriptor(
  name='NamedTensor',
  full_name='tensorflow.NamedTensor',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='tensorflow.NamedTensor.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='val', full_name='tensorflow.NamedTensor.val', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_NAMEDTENSOR.fields_by_name['val'].message_type = tensorflow_dot_core_dot_framework_dot_tensor__pb2._TENSORPROTO
_RUNGRAPHREQUEST.fields_by_name['exec_opts'].message_type = _EXECUTOROPTS
_RUNGRAPHREQUEST.fields_by_name['send'].message_type = _NAMEDTENSOR
_RUNGRAPHRESPONSE.fields_by_name['recv'].message_type = _NAMEDTENSOR
...
NamedTensor = _reflection.GeneratedProtocolMessageType('NamedTensor', (_message.Message,), dict(
